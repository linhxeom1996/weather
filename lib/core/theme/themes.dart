...
class AppThemeData {
  ...
  factory AppThemeData({
    ...
    required AppColorScheme colorScheme,
      ...
      AppThemeData.raw(
          ...
          textThemeT2: AppTextTheme.create(colorScheme.textColor.withOpacity(0.6)),
          ...
          buttonThemeT2: AppTextTheme.create(colorScheme.btnColor.withOpacity(0.5)),
  ...
  ThemeData get themeData => ThemeData(
      ...
      textSelectionTheme: TextSelectionThemeData(cursorColor: colorScheme.textColor),
      iconTheme: IconThemeData(color: colorScheme.iconColor, size: Dimens.icon15), colorScheme: ColorScheme.light(
        brightness: brightness,
...
class AppTextTheme {
  ...
  factory AppTextTheme.create(Color color) {
    final fontFamily = FontApp.interRegular.name;
    return AppTextTheme(
      bigTitle: TextStyle(
